...
export const defaultTestsFolderName = "eureka-plus";
// ---------------------------------------------------------------
...
export const playwrightTestLibraryPath =
  "https://github.com/eureka-egain/eureka-plus/releases/download/1.51.0-1.6.0/pw-test.tgz";
export const playwrightLibraryPath =
  "https://github.com/eureka-egain/eureka-plus/releases/download/1.51.0-1.6.0/pw.tgz";
// ---------------------------------------------------------------
