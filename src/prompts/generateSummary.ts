...
Steps:
<ol>
  <li>Navigate to a specific URL: http://192.168.0.108:3000/work/eBrain/folder/409600000015695.</li>
  <li>Click the "Add Article" button using its test ID (button-articles-add).</li>
  <li>Focus on the title input field for creating or editing an article.</li>
  <li>Fill the title input field with the value ar11322.</li>
  <li>Open a dropdown menu for selecting the article type.</li>
  <li>Select the "General" option from the dropdown menu.</li>
  <li>Click the "Done" button to finalize the creation of the new article.</li>
  <li>Verify that the article editor contains the text ar11322.</li>
</ol>
Summary:
